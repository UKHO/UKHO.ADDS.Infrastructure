...
namespace UKHO.ADDS.Infrastructure.Results
{
    ...
    public readonly struct Result : IEquatable<Result>, IActionableResult<Result>
    {
        ...
        private static readonly Result _successResult = new(true);
        internal static readonly Result _failureResult = new(Error.Empty);
        ...
        public static Result Failure() => _failureResult;
        ...
        {
            var dictionary = new Dictionary<string, object>(1) { { metadata.Key, metadata.Value } };
        ...
        public static Result Failure(Exception ex)
        {
            ...
            var metadata = new Dictionary<string, object>(1) { { "Exception", ex } };
